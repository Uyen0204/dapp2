...
contract CompanyTreasuryManager is Ownable, ReentrancyGuard {
    ...
    address public roleManagementFullAddress;
    ...
    uint256 public constant WAREHOUSE_SPENDING_LIMIT_PER_PERIOD = 500 ether;
    ...
    constructor(
        ...
        // THAY ĐỔI:
        require(_itemsManagementCoreAddress != address(0), "CTM: Dia chi ItemsManagementCore khong hop le");
        ...
        roleManagementFullAddress = _roleManagementAddress;
    ...
    function setInitialFinanceDirector(address _director) external onlyOwner {
        ...
        require(financeDirector == address(0), "CTM: Giam doc Tai chinh ban dau da duoc thiet lap");
    ...
    function setWarehouseSpendingPolicy(
        ...
        require(whInfo.exists, "CTM: Kho khong ton tai trong IMCore");

        // THAY ĐỔI:
        SupplierInfo memory supInfo = itemsManagementCore.getSupplierInfo(_supplierAddress);
        require(supInfo.exists && supInfo.isApprovedByBoard, "CTM: NCC khong ton tai hoac chua duoc phe duyet trong IMCore");
